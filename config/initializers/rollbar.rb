...
Rollbar.configure do |config|
  ...
  config.access_token = 'e44ea585f62d43368a4275163114446d'
  enable_rollbar = ActiveModel::Type::Boolean.new.cast(ENV.fetch('ENABLE_ROLLBAR', true))
  config.enabled = enable_rollbar && Rails.env.production?
